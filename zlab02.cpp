...
void ZLab02::zadanie_2_3() {
    ...
    cout << "Zmienna c2 jest typu: " << typeid(b).name()
            ...
            << " -> " << unsigned_int_max << ", to oznacza " << unsigned_int_zakres << " roznych wartosci"
            << endl
...
void ZLab02::menu() {
    ...
    switch (wybor) {
        ...
        case 10:
            short min, max;
            cout << "Podaj poczatek zakresu losowania: ";
            cin >> min;
            cout << "Podaj koniec zakresu losowania: ";
            cin >> max;
